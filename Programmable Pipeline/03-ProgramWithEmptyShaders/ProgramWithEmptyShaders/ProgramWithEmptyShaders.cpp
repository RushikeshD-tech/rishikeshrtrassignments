...
#include<gl/glew.h> // for GLSL extensions IMPORANT : This Line Should Be Before #including<gl\gl.h> And #include<gl\glu.h>
...
enum
{
	RAD_ATRRIBUTE_VERTEX = 0,
    RAD_ATRRIBUTE_COLOR,
	RAD_ATRRIBUTE_NORMAL,
	RAD_ATRRIBUTE_TEXTURE0,
};
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindow(szClassName,
		TEXT("Rishikesh Dumbre : Program With Empty Shader Window"),
		WS_OVERLAPPEDWINDOW,
		100,
		100,
		WIN_WIDTH,
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CLOSE: // Parallel to glutCloseFunc();
		uninitialize(); // Parallel to glutCloseFunc(unintialize);
		break;
	case WM_DESTROY:
		PostQuitMessage(0);
		break;
...
void initialize(void)
{
	...
	//GLEW Initialization Code For GLSL (IMPORTANT : It Must Be Here. Means After Creating OpenGL Context But Using Any OpenGL Function)
	...
	//set background color to which it will display even if it will empty. THIS LINE CAN BE IN drawReact().
...
void uninitialize(void)
{
	...
	// detach vertex shader from shder program object
