...
#include <X11/keysym.h>
  ...
  XGCValues gcValues;
  XColor greencolor;
   char str[]="Hello XWindows From Rishikesh Dumbre";
   int StringLenth;
   int StringWidth;
   int StringHeight;
   int FontHeight;
...
break;
  ...
  break;
   ...
   //XLoadNamedColor(gpDisplay, gColormap, "green", &greencolor, &greencolor);
   XAllocNamedColor(gpDisplay, gColormap, "green",&greencolor ,&greencolor);
   XSetForeground(gpDisplay, gc, greencolor.pixel);

   StringLenth=strlen(str);
   StringWidth=XTextWidth(pXFontStruct, str, StringLenth);
   FontHeight=pXFontStruct->ascent+pXFontStruct->descent;
   XDrawString(gpDisplay, gWindow, gc, (winWidth/2-StringWidth/2), (winHeight/2-StringHeight/2), str, StringLenth);
break;
    case DestroyNotify:
    break;
   case 33:
...
XStoreName(gpDisplay, gWindow,"Rishikesh Dumbre");
...
XMapWindow(gpDisplay, gWindow) ;
   ...
   void ToggleFullscreen(void)
    ...
    //code
    wm_state=XInternAtom(gpDisplay,"NET_WM_STATE",False);
